...
<div class="btn-toolbar list-toolbar">
    <a href="?page=addsiswa1"><button class="btn btn-primary"  ><i class="fa fa-plus"></i> Tambah Siswa Kelas X</button></a>  
...
<table width="1068" class="table table-striped table-bordered table-condensed" id="example1">
  ...
  <?php
	...
	$mySql = "SELECT * FROM siswa ORDER BY no_induk ASC LIMIT $halaman, $baris";
  ...
  <tr>
    ...
    <td width="48" align="center"> <a href="#myModal" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i> Hapus</a></td>
  ...
  <tr>
	...
	for ($h = 1; $h <= $maksData; $h++) {
		...
		echo " <a href='?page=data_siswa1&hal=$list[$h]'>$h</a> ";
	}
	?></td>
  </tr>
</table>
