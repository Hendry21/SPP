...
<?php include("kelas_siswa.php"); ?>
<br >
<table width="748" height="165" align="center" class="table table-striped table-bordered table-condensed">
<tr>
	  <td width="79" height="31" class="head-data">Laporan Pembayaran Siswa Per UAS</td>
  </tr>
	<?php 
	...
	if ($siswa=="") {
		...
		<tr><td class='head-data' align='center' colspan='5'>Data Pembayaran Siswa Per UAS</td></tr>
